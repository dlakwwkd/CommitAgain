...
{
     SpriteFrameCache::getInstance()->addSpriteFramesWithFile("Images/Effect/FireWall/FireWall.plist");
...
//      m_FireSprite8->runAction(MakeFastAnimationForever("fire_B%02d.png", 25));
     m_Sprite->runAction(MakeFastAnimationForever("FireWall%02d.png", 14));
